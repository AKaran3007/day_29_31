...
function ViewStudent() {
    ...
    let loadStudent = async () => {
        try {
            let student = await axios.get(`https://62ab049e371180affbdf40f1.mockapi.io/student/${params.id}`)
                ...
                <div class='row'>
                    <div class='col-12 mx-auto'>
                        <div class="card" style={{ width: '18rem' }}>
                            <img src="./images/male-postman.png" class="card-img-top offset-6 py-2 mt-3 mx-auto rounded-circle" alt="..." style={{ borderRadius: '50%', width: '8rem', height: '8rem' }} />
                            <div class="card-body">
